...
Test(nfs_write_test_suite, write_ok, .description = "NFSPROC_WRITE ok") {
    ...
    Nfs__DirOpRes *write_test_dir_diropres = lookup_file_or_directory_success(NULL, &fhandle, "write_test", NFS__FTYPE__NFDIR);
    ...
    Nfs__DirOpRes *diropres = lookup_file_or_directory_success(NULL, &write_test_dir_fhandle, "write_test_file.txt", NFS__FTYPE__NFREG);
    ...
    Nfs__AttrStat *attrstat = write_to_file_success(NULL, &file_fhandle, 6, 4, "done", NFS__FTYPE__NFREG);
    ...
    Nfs__ReadRes *readres = read_from_file_success(NULL, &file_fhandle, 0, expected_read_size, attrstat->attributes, expected_read_size, expected_new_test_file_content);
...
Test(nfs_write_test_suite, write_no_such_file, .description = "NFSPROC_WRITE no such file") {
    ...
    write_to_file_fail(NULL, &file_fhandle, 2, 5, "write", NFS__STAT__NFSERR_NOENT);
...
Test(nfs_write_test_suite, write_is_directory, .description = "NFSPROC_WRITE directory specified for a non-directory operation") {
    ...
    write_to_file_fail(NULL, &fhandle, 2, 5, "write", NFS__STAT__NFSERR_ISDIR);
}
...
Test(nfs_write_test_suite, write_too_much_data, .description = "NFSPROC_WRITE more than NFS_MAXDATA bytes in nfsdata") {
    ...
    write_to_file_fail(NULL, &file_fhandle, 6, NFS_MAXDATA + 20, content, NFS__STAT__NFSERR_FBIG);
