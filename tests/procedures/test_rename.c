...
Test(nfs_rename_test_suite, rename_ok, .description = "NFSPROC_RENAME ok") {
    ...
    Nfs__DirOpRes *rename_test_dir_diropres = lookup_file_or_directory_success(rpc_connection_context, &fhandle, "rename_test", NFS__FTYPE__NFDIR);
    ...
    Nfs__DirOpRes *dir1_diropres = lookup_file_or_directory_success(rpc_connection_context, &rename_test_dir_fhandle, "dir1", NFS__FTYPE__NFDIR);
    Nfs__DirOpRes *dir2_diropres = lookup_file_or_directory_success(rpc_connection_context, &rename_test_dir_fhandle, "dir2", NFS__FTYPE__NFDIR);
    ...
    Nfs__DirOpRes *rename_test_file_diropres = lookup_file_or_directory_success(rpc_connection_context, &dir1_fhandle, "rename_test_file.txt", NFS__FTYPE__NFREG);
    ...
    Nfs__NfsStat *nfsstat = rename_file_success(rpc_connection_context, &dir1_fhandle, "rename_test_file.txt", &dir2_fhandle, "renamed_file.txt");
    ...
    Nfs__ReadDirRes *dir1_readdirres = read_from_directory_success(rpc_connection_context, &dir1_fhandle, 0, 1000, dir1_expected_number_of_entries, dir1_expected_filenames);
    ...
    Nfs__ReadDirRes *dir2_readdirres = read_from_directory_success(rpc_connection_context, &dir2_fhandle, 0, 1000, dir2_expected_number_of_entries, dir2_expected_filenames);
    ...
    Nfs__DirOpRes *renamed_file_diropres = lookup_file_or_directory_success(rpc_connection_context, &dir2_fhandle, "renamed_file.txt", NFS__FTYPE__NFREG);
...
Test(nfs_rename_test_suite, rename_no_such_from_directory, .description = "NFSPROC_RENAME no such 'from' directory") {
    ...
    rename_file_fail(rpc_connection_context, &fhandle, "remove_file_test.txt", &fhandle, "renamed_file.txt", NFS__STAT__NFSERR_NOENT);
...
Test(nfs_rename_test_suite, move_file_from_a_non_directory, .description = "NFSPROC_RENAME move file from a non-directory") {
    ...
    rename_file_fail(rpc_connection_context, &file_fhandle, "rename_test_file.txt", &fhandle, "renamed_file.txt" ,NFS__STAT__NFSERR_NOTDIR);
...
Test(nfs_rename_test_suite, rename_no_such_file, .description = "NFSPROC_REMOVE no such file") {
    ...
    rename_file_fail(rpc_connection_context, &fhandle, NONEXISTENT_FILENAME, &fhandle, "renamed_file.txt",NFS__STAT__NFSERR_NOENT);
...
Test(nfs_rename_test_suite, rename_no_such_to_directory, .description = "NFSPROC_RENAME no such 'to' directory") {
    ...
    rename_file_fail(rpc_connection_context, &fhandle, "test_file.txt", &to_fhandle, "renamed_file.txt", NFS__STAT__NFSERR_NOENT);
...
Test(nfs_rename_test_suite, move_file_to_a_non_directory, .description = "NFSPROC_RENAME move file to a non-directory") {
    ...
    rename_file_fail(rpc_connection_context, &fhandle, "test_file.txt", &file_fhandle, "renamed_file.txt" ,NFS__STAT__NFSERR_NOTDIR);

    free_rpc_connection_context(rpc_connection_context);
}

Test(nfs_rename_test_suite, make_directory_a_subdirectory_of_itself, .description = "NFSPROC_RENAME make directory a subdirectory of itself") {
    RpcConnectionContext *rpc_connection_context = create_test_rpc_connection_context(TEST_TRANSPORT_PROTOCOL);
    if(rpc_connection_context == NULL) {
    ...
    Nfs__DirOpRes *dir3_diropres = lookup_file_or_directory_success(rpc_connection_context, &rename_test_dir_fhandle, "dir3", NFS__FTYPE__NFDIR);
    ...
    rename_file_fail(rpc_connection_context, &rename_test_dir_fhandle, "dir3", &dir3_fhandle, "newdir", NFS__STAT__NFSERR_EXIST);

    free_rpc_connection_context(rpc_connection_context);
}

Test(nfs_rename_test_suite, overwrite_non_empty_directory, .description = "NFSPROC_RENAME overwrite a nonempty directory") {
    RpcConnectionContext *rpc_connection_context = create_test_rpc_connection_context(TEST_TRANSPORT_PROTOCOL);
    if(rpc_connection_context == NULL) {
    ...
    rename_file_fail(rpc_connection_context, &rename_test_dir_fhandle, "dir2", &rename_test_dir_fhandle, "dir1", NFS__STAT__NFSERR_NOTEMPTY);
...
Test(nfs_rename_test_suite, rename_has_write_permission_on_from_and_to_containing_directories, .description = "NFSPROC_RENAME has write permissions on from and to containing directories") {
    ...
    if(rpc_connection_context == NULL) {
        cr_fatal("rename_has_write_permission_on_from_and_to_containing_directories: Failed to connect to the server\n");
    }
