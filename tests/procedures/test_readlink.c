...
Test(nfs_readlink_test_suite, readlink_ok, .description = "NFSPROC_READLINK ok") {
    ...
    Nfs__DirOpRes *readlink_test_dir_diropres = lookup_file_or_directory_success(NULL, &fhandle, "readlink_test", NFS__FTYPE__NFDIR);
    ...
    Nfs__DirOpRes *symlink_diropres = lookup_file_or_directory_success(NULL, &readlink_test_dir_fhandle, "symlink", NFS__FTYPE__NFLNK);
    ...
    Nfs__ReadLinkRes *readlinkres = read_from_symbolic_link_success(NULL, &symlink_fhandle, expected_symlink_target_path);
...
Test(nfs_readlink_test_suite, readlink_no_such_file, .description = "NFSPROC_READLINK no such file") {
    ...
    read_from_symbolic_link_fail(NULL, &symlink_fhandle, NFS__STAT__NFSERR_NOENT);
...
Test(nfs_readlink_test_suite, readlink_not_a_symboliclink, .description = "NFSPROC_READLINK specified file which is not a symbolic link") {
    ...
    read_from_symbolic_link_fail(NULL, &readlink_test_dir_fhandle, NFS__STAT__NFSERR_STALE);
}