...
Test(nfs_link_test_suite, link_ok, .description = "NFSPROC_LINK ok") {
    ...
    Nfs__NfsStat *nfsstat = create_link_to_file_success(NULL, &target_file_fhandle, &link_test_dir_fhandle, "hardlink");
    ...
    Nfs__DirOpRes *link_diropres = lookup_file_or_directory_success(NULL, &link_test_dir_fhandle, "hardlink", NFS__FTYPE__NFREG);
...
Test(nfs_link_test_suite, link_no_such_target_file, .description = "NFSPROC_LINK no such target file") {
    ...
    create_link_to_file_fail(NULL, &target_file_fhandle, &link_test_dir_fhandle, "hardlink" , NFS__STAT__NFSERR_NOENT);
}
...
Test(nfs_link_test_suite, link_target_file_is_a_directory, .description = "NFSPROC_LINK target file is a directory") {
    ...
    Nfs__DirOpRes *target_file_diropres = lookup_file_or_directory_success(NULL, &link_test_dir_fhandle, "existing_directory", NFS__FTYPE__NFDIR);
    ...
    create_link_to_file_fail(NULL, &target_file_fhandle, &link_test_dir_fhandle, "hardlink" , NFS__STAT__NFSERR_ISDIR);
}
...
Test(nfs_link_test_suite, link_no_such_directory, .description = "NFSPROC_LINK no such directory") {
    ...
    create_link_to_file_fail(NULL, &target_file_fhandle, &dir_fhandle, "hardlink", NFS__STAT__NFSERR_NOENT);
}
...
Test(nfs_link_test_suite, link_create_a_hard_link_in_a_non_directory, .description = "NFSPROC_LINK create hard link in a non-directory") {
    ...
    create_link_to_file_fail(NULL, &target_file_fhandle, &file_fhandle, "hardlink", NFS__STAT__NFSERR_NOTDIR);
}
...
Test(nfs_link_test_suite, link_file_name_too_long, .description = "NFSPROC_LINK file name too long") {
    ...
    create_link_to_file_fail(NULL, &target_file_fhandle, &link_test_dir_fhandle, filename, NFS__STAT__NFSERR_NAMETOOLONG);
}
...
Test(nfs_link_test_suite, create_hard_link_that_is_an_already_existing_file, .description = "NFSPROC_LINK create hard link that is an already existing file") {
    ...
    create_link_to_file_fail(NULL, &target_file_fhandle, &link_test_dir_fhandle, "existing_file", NFS__STAT__NFSERR_EXIST);
}
