...
#define NFS_SHARE_ENTRIES {"..", ".", "write_test", "readlink_test", "create_test", "remove_test", "rename_test", "symlink_test", "mkdir_test", "rmdir_test", "permission_test", "a.txt", "test_file.txt", "large_file.txt"}
#define NFS_SHARE_NUMBER_OF_ENTRIES 14
