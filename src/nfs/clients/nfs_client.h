...
/*
 * Every procedure returns 0 on successful execution, and in that cases places non-NULL procedure results in the last
 * argument that is passed to it. In case of unsuccessful execution, the procedure returns an error code > 0, from
 * client_common_rpc.c.
 */
