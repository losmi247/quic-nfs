...
void *blocking_read(void *arg) {
    ...
    int error_code;
    Nfs__FHandle *file_fhandle = resolve_absolute_path(rpc_connection_context, filesystem_root_fhandle, read_data->path,
    ...
    do {
        ...
        // save the read data
        size_t bytes_to_save = readres->readresbody->nfsdata.len <= bytes_left_to_read
                                   ? readres->readresbody->nfsdata.len
                                   : bytes_left_to_read;
