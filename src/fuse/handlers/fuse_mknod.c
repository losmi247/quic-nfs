...
void *blocking_mknod(void *arg) {
    ...
    Nfs__FHandle *containing_directory_fhandle = resolve_absolute_path(rpc_connection_context, filesystem_root_fhandle, mknod_data->containing_directory_path, &file_type);
